function CalculoIMC(){
    ...
    document.getElementById("imagem").src="images/magrelinho.gif";
    }

    else if(imc >=25)
    {
    document.getElementById("mensagem").innerText = "Sobrepeso";
    document.getElementById("imagem").src="images/dogchorando.gif";
    }
    else
    {
    document.getElementById("mensagem").innerText = "OK";
    document.getElementById("imagem").src="images/cachorro.gif";
    }
